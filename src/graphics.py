...
This module takes care of plotting a few of the fundamental time-series generated by the dynamics module using plotly.
Mostly used with the Network Economy ABM web-application available at (TODO)
"""
